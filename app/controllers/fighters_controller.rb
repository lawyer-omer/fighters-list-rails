class FightersController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to fighters_path, notice: "Not Authorizes" if @fighter.nil?
  end
  ...
  private
    ...
    def fighter_params
      params.require(:fighter).permit(:first_name, :last_name, :phone, :style, :rank, :start_date, :last_payment, :notes, :user_id)
    end
end
